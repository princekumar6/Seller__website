...
class Account(AbstractUser):
    ...
    RepresentativeDocType = models.CharField(max_length=10,choices=REPR_CHOICES,null=True)
    RepresentativeDoc = models.FileField(storage=KYCDocStorage,upload_to=get_file_path_company_repr_doc)
    RepresentativeDOB = models.DateField(null=True)
    ...
    companyCategory = models.CharField(max_length=20,choices=COMAPNY_CATEGORY,null=True)
    ...
    compnayCIN = models.CharField(max_length=30)
    companyKYCDocType = models.CharField(max_length=30,choices=DOC_TYPE_CHOIES)
    companyKYCDOC = models.FileField(upload_to=get_file_path_company_doc,storage=KYCDocStorage)
